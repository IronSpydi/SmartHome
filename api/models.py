...
class ControlSystemRegistration(models.Model):
...
class Subscriptions(models.Model):
    ...
    serial_no = models.OneToOneField(
        ControlSystemRegistration, on_delete=models.RESTRICT)
...
class Home(models.Model):
    serial_no = models.ForeignKey(User, on_delete=models.CASCADE)
    name = models.CharField(max_length=50)
